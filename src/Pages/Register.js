      ...
      <form onSubmit={handleRegisterAndLogin}>
        <div class="container col-md-3">
          <div class="row">
            <img
              src="logo.png"
              class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|} mx-auto col-md-6 my-4"
              alt=""
            />
              ...
              <div class="card-body">
                <div className="col-md-12">
                  ...
                  <small>
                    ...
                    <Link to="/https://www.primevideo.com/help/ref=av_auth_te?nodeId=202064890">
